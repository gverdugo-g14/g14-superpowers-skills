...
```
Clone https://github.com/gverdugo-g14/g14-superpowers-skills to ~/.config/opencode/superpowers, then create directory ~/.config/opencode/plugins, then symlink ~/.config/opencode/superpowers/.opencode/plugins/superpowers.js to ~/.config/opencode/plugins/superpowers.js, then symlink ~/.config/opencode/superpowers/skills to ~/.config/opencode/skills/superpowers, then restart opencode.
```
...
if [ -d ~/.config/opencode/superpowers ]; then
  ...
  git clone https://github.com/gverdugo-g14/g14-superpowers-skills.git ~/.config/opencode/superpowers
fi
...
git clone https://github.com/gverdugo-g14/g14-superpowers-skills.git "%USERPROFILE%\.config\opencode\superpowers"
...
```powershell
# 1. Install Superpowers
git clone https://github.com/gverdugo-g14/g14-superpowers-skills.git "$env:USERPROFILE\.config\opencode\superpowers"
...
- Report issues: https://github.com/gverdugo-g14/g14-superpowers-skills/issues
- Main documentation: https://github.com/gverdugo-g14/g14-superpowers-skills
